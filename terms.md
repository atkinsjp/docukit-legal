---
layout: default
title: DocuKit Terms of Use
permalink: /terms/
---

# DocuKit Terms of Use

**Effective date: September 9, 2026**

These Terms of Use govern your use of DocuKit: PDF Editor & Scanner (“DocuKit”), provided by Atkins Media, LLC (“Atkins Media,” “we,” “us,” or “our”). By creating an account or using DocuKit, you agree to these Terms. If you do not agree, do not use the service.

## 1. The service

DocuKit provides tools for scanning, creating, organizing, converting, compressing, signing, encrypting, and otherwise working with documents and related files. Some features run locally on your device. Other features require an internet connection and send selected content to our servers or service providers.

Features may change, be limited, or be discontinued. We do not guarantee that DocuKit will support every file, format, device, or workflow.

## 2. Accounts

You must provide accurate account information and protect access to your account. You are responsible for activity performed through your account. Notify us at [support@atkinsmedia.io](mailto:support@atkinsmedia.io) if you believe your account has been compromised.
...
AI-generated output may be inaccurate, incomplete, offensive, or unsuitable for its intended purpose. You must review and verify all output before relying on, sharing, signing, filing, or distributing it.

Do not rely on AI output as legal, medical, financial, tax, compliance, or other professional advice. We do not guarantee that AI output is accurate, original, or free from third-party claims.
...
- Use DocuKit for unlawful, fraudulent, deceptive, harmful, or abusive activity.
- Attempt to bypass security, authentication, usage, upload, or processing limits.
- Upload malware or content designed to disrupt the service.
- Probe, scrape, reverse engineer, or interfere with the service except where applicable law expressly permits it.
